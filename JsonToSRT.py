...
# Solicitar al usuario ingresar el JSON
...
# Solicitar al usuario ingresar el nombre del archivo SRT (sin la extensión)
srt_filename = input("Ingrese el nombre del archivo SRT para guardar (sin la extensión .srt): ")
srt_filename += ".srt"  # Agregar la extensión .srt
